    ...
    @push('scripts')
        <script type="module">
                ...
                initChart(series, categories) {
                    if (document.getElementById("line-chart") && typeof ApexCharts !== 'undefined') {
                        const chart = new ApexCharts(document.getElementById("line-chart"), {
                            ...
                            series: [{
                                    name: "Late",
                                    data: series.lateCount,
                                    color: "#1A56DB",
                                },
                                {
                                    name: "On Time",
                                    data: series.onTimeCount,
                                    color: "#7E3AF2",
                                },
                            ],
                            legend: {
            ...
            try {
                ...
                let series = {
                    lateCount: json.data.map((data) => data.late),
                    onTimeCount: json.data.map((data) => data.on_time)
                }

                Line.initChart(series, categories);
            } catch (error) {
