<aside
    ...
    <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
        ...
        <ul class="space-y-2">
            ...
            @can('viewAny', App\Models\VacationRequest::class)
                <li>
            ...
            {{-- <li>
                <x-nav-dropdown-button :active="request()->routeIs('dashboard')">
                    <x-slot:icon>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="size-6">
                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <ul id="dropdown-pages" class="{{ request()->routeIs('dashboard') ? '' : 'hidden' }} py-2 space-y-2">
                    <li>
                        <x-nav-dropdown-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                            Bruh
                        </x-nav-dropdown-link>
                    </li>
