<x-layouts.employee>
    ...
    <div
        ...
        <h5 class="text-xl font-medium text-gray-900 dark:text-white">Hello {{ auth()->user()->name }}</h5>
        <p id="date" class="text-gray-500 dark:text-gray-400"></p>
    ...
    @push('scripts')
        <script type="module">
            setInterval(() => {
                document.getElementById('date').textContent = new Date().toLocaleString('en', {
